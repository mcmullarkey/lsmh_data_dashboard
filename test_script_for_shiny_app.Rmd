...
# Use that data to filter the dataset (Potential future problem, if this isn't assessed/there's an NA the person gets dropped from all inclusion criteria even if they would otherwise qualify, need to figure out if there's a fix for this)
