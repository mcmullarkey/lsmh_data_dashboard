...
screening <- list(race_var = race_var, sgm_var = sgm_var, sitb_var = sitb_var, qual_var = qual_var)
...
data_highlight <- all_dash %>% 
        filter(sgm == deframe(multi_ex[1,"sgm_var"]) | sgm == deframe(multi_ex[2,"sgm_var"]),
               qual_feed == deframe(multi_ex[1,"qual_var"]) | sgm == deframe(multi_ex[2,"qual_var"]))
